...
public class PaymentsOfTheDayAdapter extends RecyclerView.Adapter<PaymentsOfTheDayAdapter.MyViewHolder> {
    ...
    public PaymentsOfTheDayAdapter(Activity activity, Context context, ArrayList loan_Id, ArrayList clientFullName, ArrayList clientDirection, ArrayList paymentFrecuency, ArrayList startDate, ArrayList dueDate,
    ...
    @NonNull
    @Override
    public PaymentsOfTheDayAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.list_item_view_loans, parent, false);
        return new PaymentsOfTheDayAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PaymentsOfTheDayAdapter.MyViewHolder holder, int position) {
